package Signals is
  ...
  function "-"(S1: Signal; S2: Signal) return Signal;
  function "*"(S1: Signal; S2: Signal) return Signal; -- Linear w-Selector, dot product
  function "*"(v: Value; S: Signal) return Signal; --Linear scale
  function "**"(S1: Signal; S2: Signal) return Signal; --Convolution
  function modtime(from,to: Integer; time_delay: Integer := 0) return Signal;
  function saw(from,to: Integer; time_delay: Integer := 0) return Signal; --AKA modtime signal /12
